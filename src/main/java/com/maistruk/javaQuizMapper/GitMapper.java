...
public class GitMapper {
    ...
    public static void mapping() { // BufferedReader 10 times faster than simply Reader
        ...
        try (BufferedReader reader = Files.newBufferedReader(Paths.get(
                "D:/Programming/Java/JAVA QUIZ PROJECT(FOR WORK)/java question/Spring Hibernate Java Quiz/SQL/Git/Questions.txt"))) {
            int letter;
        ...
        try (Writer writer = Files.newBufferedWriter(Paths.get(
                "D:/Programming/Java/JAVA QUIZ PROJECT(FOR WORK)/java question/Spring Hibernate Java Quiz/SQL/Git/QuestionsSQL.txt"))) {
    ...
    public static void writeQuestion(Writer writer,String str, int questionId) throws IOException {
        str = str.replaceAll(" +", " ");
        writer.write("INSERT INTO git_question (id, question) VALUES (" + questionId + ", '" + str
                + "');\n");
    }
    ...
    public static void writeAnswer(Writer writer,String str,  int answerId) throws IOException {
        if (str.contains("(True)")) {
            ...
            writer.write("INSERT INTO git_answer (id, answer, flag) VALUES (" + answerId + ", '" + str
                    + "', true);\n");
