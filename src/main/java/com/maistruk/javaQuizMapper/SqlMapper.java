...
public class SqlMapper {
    ...
    public static void mapping() { 
        ...
        try (BufferedReader reader = Files.newBufferedReader(Paths.get(
                "D:/Programming/Java/JAVA QUIZ PROJECT(FOR WORK)/java question/Spring Hibernate Java Quiz/SQL/SQL/Questions.txt"))) {
            int letter;
        ...
        try (Writer writer = Files.newBufferedWriter(Paths.get(
                "D:/Programming/Java/JAVA QUIZ PROJECT(FOR WORK)/java question/Spring Hibernate Java Quiz/SQL/SQL/QuestionsSQL.txt"))) {
    ...
    public static void writeQuestion(Writer writer,String str, int questionId) throws IOException {
        str = str.replaceAll(" +", " ");
        writer.write("INSERT INTO sql_question (id, question) VALUES (" + questionId + ", '" + str
                + "');\n");
    }
    ...
    public static void writeAnswer(Writer writer,String str,  int answerId) throws IOException {
        if (str.contains("(True)")) {
            ...
            writer.write("INSERT INTO sql_answer (id, answer, flag) VALUES (" + answerId + ", '" + str
                    + "', true);\n");
